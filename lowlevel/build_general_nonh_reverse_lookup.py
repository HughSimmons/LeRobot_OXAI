...
from multisim_chess_fast import (
    ...
    CRITICAL_TILT_PERTURB_ENABLED,
    CRITICAL_TILT_PERTURB_FINAL_SETTLE_STEPS,
    CRITICAL_TILT_RANGE_DEG,
    CRITICAL_TILT_TWIST_STEPS,
    board_origin,
...
def build_metadata():
    ...
    return {
        ...
        "critical_tilt_angular_velocity": CRITICAL_TILT_ANGULAR_VELOCITY,
        "critical_tilt_twist_steps": CRITICAL_TILT_TWIST_STEPS,
        "critical_tilt_perturb_final_settle_steps": CRITICAL_TILT_PERTURB_FINAL_SETTLE_STEPS,
